...
<div class="plans-container">
    <div class="plan">
      ...
      <form method="GET" action="{{ route('registration_freelancer') }}">
...
<!-- Modalplus -->
<div class="modal fade" id="exampleModalplus" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Payment Process</h5>
